...
misc_analyses.py: Several analyses on copy number calls.
...
Takes one argument: the pickled pandas data frame of copy number calls.


1000_Genomes_amplicons_calls.pickle: pickled pandas dataframe of 1000 Genomes Project copy number calls. This is the same data as Table S4 in Teitz et al. 2018, in the format needed to input into predict_azfc_architectures.py; this is the file format that is generated by call_amplicon_cn.py in the CNV Detection/Whole CNV Detection directory.